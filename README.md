...
I'm a problem solver who thrives on understanding how systems work and why they break. Currently an SRE at **Moniepoint**, supporting Africa's all-in-one financial ecosystem serving 10 million businesses.

Previously blended Support and DevOps in banking at **Stanbic IBTC**. Now building systems that keep up with fast-moving teams.

- Improved transaction success rates from 97.8% to 99.4%
- Cut mean time to detect issues by 40%
- Supporting systems processing ₦30B+ monthly

## Certifications

![Terraform](https://img.shields.io/badge/HashiCorp-Terraform_Associate_(003)-7B42BC?style=flat-square&logo=terraform&logoColor=white)
![KCNA](https://img.shields.io/badge/CNCF-KCNA_Certified-326CE5?style=flat-square&logo=kubernetes&logoColor=white)
...
![AppDynamics](https://img.shields.io/badge/AppDynamics-00A1E0?style=flat-square&logo=appdynamics&logoColor=white)
...
- **Incident Response** — Lead war rooms, deliver RCAs, reduce repeat incidents
- **Observability** — Build dashboards and alerts for critical metrics
- **CI/CD** — Support deployments with Git, Argo CD, GitHub Actions
